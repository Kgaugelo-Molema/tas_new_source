...
$dataCols = "`DATESTAMP`, `TIME`, `IP`, `BROWSER`, `PROV_CODE`, `DESCRIPTION`";
...
$sqltext = "INSERT INTO $mysql_table (".$dataCols.")
                   ...
                   '".date("G:i:s")."',
                   '".$_SERVER['REMOTE_ADDR']."',
                   '".$_SERVER['HTTP_USER_AGENT']."','LP','Limpopo')";
...
$sqltext = "INSERT INTO $mysql_table (".$dataCols.")
                   ...
                   '".date("G:i:s")."',
                   '".$_SERVER['REMOTE_ADDR']."',
                   '".$_SERVER['HTTP_USER_AGENT']."','MP','Mpumalanga')";
...
$sqltext = "INSERT INTO $mysql_table (".$dataCols.")
                   ...
                   '".date("G:i:s")."',
                   '".$_SERVER['REMOTE_ADDR']."',
                   '".$_SERVER['HTTP_USER_AGENT']."','NW','North West')";
...
$sqltext = "INSERT INTO $mysql_table (".$dataCols.")
                   ...
                   '".date("G:i:s")."',
                   '".$_SERVER['REMOTE_ADDR']."',
                   '".$_SERVER['HTTP_USER_AGENT']."','FS','Free State')";
...
$sqltext = "INSERT INTO $mysql_table (".$dataCols.")
                   ...
                   '".date("G:i:s")."',
                   '".$_SERVER['REMOTE_ADDR']."',
                   '".$_SERVER['HTTP_USER_AGENT']."','EC','Eastern Cape')";
...
$sqltext = "INSERT INTO $mysql_table (".$dataCols.")
                   ...
                   '".date("G:i:s")."',
                   '".$_SERVER['REMOTE_ADDR']."',
                   '".$_SERVER['HTTP_USER_AGENT']."','WC','Western Cape')";
...
$sqltext = "INSERT INTO $mysql_table (".$dataCols.")
                   ...
                   '".date("G:i:s")."',
                   '".$_SERVER['REMOTE_ADDR']."',
                   '".$_SERVER['HTTP_USER_AGENT']."','NC','Northern Cape')";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo $row["PROV_CODE"]. " | " . $row["DESCRIPTION"]. "<br>";
